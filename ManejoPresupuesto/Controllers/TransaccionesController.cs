...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController :Controller
    {
        ...
        public TransaccionesController(ServicioUsuarios servicioUsuarios, IRepositorioCuentas repositorioCuentas,
        ...
        {
            var usuariosId = servicioUsuarios.ObtenerUsiarioId();
            var modelo = new TransaccionCreacionViewModel();
            modelo.Cuentas = await ObtenerCuentas(usuariosId);
            modelo.Categorias = await ObtenerCategorias(usuariosId, modelo.TipoOperacionId);
            return View(modelo);
        ...
        public async Task<IActionResult> Crear(TransaccionCreacionViewModel modelo)
        {
            ...
            var cuenta = await repositorioCuentas.ObetenerPorId(modelo.CuentaId, usuariosId);
            if (cuenta is null)
            {
                return RedirectToAction("NoEncontrado", "Home");
            }
            var categoria = await repositorioCategorias.ObtenerPorId(modelo.CategoriaId,usuariosId);

            if (categoria is null)
            {
                return RedirectToAction("NoEncontrado", "Home");
            }
            modelo.UsuarioId = usuariosId;
        ...
        public async Task<ActionResult> Semanal(int mes, int año)
        {
            var usuarioId = servicioUsuarios.ObtenerUsiarioId();
